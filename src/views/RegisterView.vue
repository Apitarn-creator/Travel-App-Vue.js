...
.register-card { background: white; width: 100%; max-width: 450px; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #f0f0f0; }
.register-header { text-align: center; margin-bottom: 30px; }
.register-header h2 { font-size: 2rem; color: #1a1a1a; margin-bottom: 10px; }
...
.register-footer { text-align: center; margin-top: 25px; font-size: 0.95rem; color: #666; }
